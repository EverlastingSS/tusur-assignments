...
class Goods
{
    ...
    public Goods(string name, DateTime date, double price, int quantity, string invoiceNumber) // конструктор
    {
        this.name = name;
        this.date = date;
        this.price = price;
    ...
    public void IncreaseQuantity(int amount) // + колво
    {
        if (amount <= 0)
    ...
    public double CalculateTotalCost()    // тотал 
    {return price * quantity;}
    public string GetTotalCostString()  // стоимость как строка
...
class Program
{
    ...
    static void Main()
    {
        ...
        Console.Write("Название товара на английском: ");
